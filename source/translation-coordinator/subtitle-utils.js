...
function formatWebVTTTimestamp(milliseconds) {
    ...
    // Ensure we have a clean integer value (no decimal places)
    const cleanMilliseconds = Math.floor(milliseconds);
    
    const totalSeconds = Math.floor(cleanMilliseconds / 1000);
    const ms = cleanMilliseconds % 1000;
