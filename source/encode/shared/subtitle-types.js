 ...
 * @property {CaptionSelector[]} [captionSelectors] - Caption selector configurations
 */
 ...
 * @property {string} [customLanguageCode] - Custom language code if needed
 */
 ...
 */
function createTranslationTask(sourceLanguage, targetLanguage, textSegments, jobId, metadata = {}) {
    return {
        sourceLanguage,
        targetLanguage,
        textSegments,
